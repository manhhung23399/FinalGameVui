            ...
            object : AdapterView.OnItemSelectedListener {
                override fun onItemSelected(
                    ...
                    (parent?.getItemAtPosition(position) as Genre).let {
                        viewModel.getGamesByGenre3(it.id.toString(), ApiConfig.BASE_XBOX)
                    }
                }
